    ...
    <div>
      ...
      <div className="w-11/12 max-sm:w-11/12 max-sm:ml-6 ml-16 mb-2 flex flex-row items-center h-60 mt-10 justify-evenly bg-gray-300 bg-opacity-25 rounded-lg">
        <div className=" w-60 flex flex-col text-center items-center justify-center">
          <img
            className="w-40 max-sm:w-20 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover: duration-300"
            src={image}
            alt="image"
          />
          <p className="text-black font-semibold max-sm: text-sm max-sm:w-28 max-sm:mt-5 ">
        ...
        <div className=" w-60 flex flex-col text-center items-center justify-center gap-4">
          <img
            className="w-32 max-sm:w-16 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover: duration-300"
            src={image3}
            alt="image"
          />
          <p className="text-black font-semibold mt-4 max-sm: text-sm max-sm:w-40">
            Track Your Success
          </p>
        </div>
      ...
      <div className=" bg-gray-300 bg-opacity-25 rounded-lg border-0 max-sm:w-10/12 max-sm:ml-14 max-sm:m-10 flex flex-row items-center justify-center m-10">
        <StuPage />
      </div>
      <br />
      <Footer />
